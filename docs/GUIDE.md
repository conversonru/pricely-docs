...
> Последнее обновление: 2026-04-16 · День 6 из 8 выполнен
...
| День 5 | Загрузка Excel → автоматически в каталог | ✅ Готово |
| День 6 | Поддомены (`demo.price-on.ru`) | ✅ Готово |
| День 7 | Оплата тарифов через Prodamus | ⏳ Следующий |
